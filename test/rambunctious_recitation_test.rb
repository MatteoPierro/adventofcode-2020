...
class RambunctiousRecitationTest < Minitest::Test
  ...
  def test_number_2020th
    assert_equal(436, RambunctiousRecitation.number_2020th([0, 3, 6]))
    assert_equal(1, RambunctiousRecitation.number_2020th([1, 3, 2]))
    assert_equal(10, RambunctiousRecitation.number_2020th([2, 1, 3]))
    assert_equal(27, RambunctiousRecitation.number_2020th([1, 2, 3]))
    assert_equal(78, RambunctiousRecitation.number_2020th([2, 3, 1]))
    assert_equal(438, RambunctiousRecitation.number_2020th([3, 2, 1]))
    assert_equal(1836, RambunctiousRecitation.number_2020th([3, 1, 2]))
  end

  def test_first_puzzle
    assert_equal(852, RambunctiousRecitation.number_2020th([0, 3, 1, 6, 7, 5]))
  end
end
